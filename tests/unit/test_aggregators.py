...
class TestTeamAggregation:
    ...
    def db_with_teams(self, tmp_path: Path) -> tuple[DatabaseManager, Path]:
        ...
        prs = [
            ...
            ("repo1-1", 1, "org1", "proj1", "repo1", "user1", "Backend fix 1", "completed", None, "2026-01-03", "2026-01-06", 120.0),
            ("repo1-2", 2, "org1", "proj1", "repo1", "user1", "Backend fix 2", "completed", None, "2026-01-04", "2026-01-07", 180.0),
            # user2 (Frontend only): 1 PR
            ("repo2-1", 1, "org1", "proj1", "repo2", "user2", "Frontend fix", "completed", None, "2026-01-05", "2026-01-08", 240.0),
            # user3 (Both teams): 2 PRs - should appear in BOTH team slices
            ("repo1-3", 3, "org1", "proj1", "repo1", "user3", "Cross-team 1", "completed", None, "2026-01-05", "2026-01-09", 300.0),
            ("repo2-2", 2, "org1", "proj1", "repo2", "user3", "Cross-team 2", "completed", None, "2026-01-06", "2026-01-10", 360.0),
            # user4 (No team): 1 PR - should NOT appear in any team slice
            ("repo2-3", 3, "org1", "proj1", "repo2", "user4", "No team PR", "completed", None, "2026-01-07", "2026-01-11", 420.0),
        ]
        for pr in prs:
            db.execute(
                """
