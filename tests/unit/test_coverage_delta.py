...
class TestThresholdScriptGitLogScope:
    ...
    def test_real_baseline_passes(self) -> None:
        ...
        This test uses the real .coverage-baseline.json and the real
        coverage files generated by the test suite. It only runs if
        coverage files exist (they're generated by pytest/jest before
        this test runs in the preflight).
        """
        ...
        if not python_cov.exists() or not ts_cov.exists():
            pytest.skip("Coverage files not generated yet")
