 ...
 */
export declare function createMultiplePipelinesError(
  matches: PipelineMatch[],
): PrInsightsError;
/**
 ...
 */
export declare function createNoSuccessfulBuildsError(
  pipelineName: string,
): PrInsightsError;
/**
 ...
 */
export declare function createArtifactsMissingError(
  pipelineName: string,
  buildId: number,
): PrInsightsError;
/**
 ...
 */
export declare function createPermissionDeniedError(
  operation: string,
): PrInsightsError;
/**
 ...
 */
export declare function createInvalidConfigError(
  param: string,
  value: string,
  reason: string,
): PrInsightsError;
