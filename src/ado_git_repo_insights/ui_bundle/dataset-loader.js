...
exports.DatasetLoader =
  ...
  exports.DEPRECATED_LAYOUT_ERROR =
...
function normalizeRollup(rollup) {
  ...
  return {
    ...
    cycle_time_p50:
      rollup.cycle_time_p50 ?? exports.ROLLUP_FIELD_DEFAULTS.cycle_time_p50,
    cycle_time_p90:
      rollup.cycle_time_p90 ?? exports.ROLLUP_FIELD_DEFAULTS.cycle_time_p90,
    authors_count:
      rollup.authors_count ?? exports.ROLLUP_FIELD_DEFAULTS.authors_count,
    reviewers_count:
      rollup.reviewers_count ?? exports.ROLLUP_FIELD_DEFAULTS.reviewers_count,
...
class DatasetLoader {
  ...
  async getWeeklyRollupsWithProgress(
    ...
    for (
      ...
      i += exports.fetchSemaphore.maxConcurrent
    ) {
      batches.push(
        weeksToFetch.slice(i, i + exports.fetchSemaphore.maxConcurrent),
      );
    }
    let loaded = 0;
  ...
  async _fetchWeekWithRetry(weekStr, indexEntry, context, cache) {
    ...
    while (retries <= exports.fetchSemaphore.maxRetries) {
      ...
      try {
        ...
        if (
          response.status >= 500 &&
          retries < exports.fetchSemaphore.maxRetries
        ) {
          retries++;
