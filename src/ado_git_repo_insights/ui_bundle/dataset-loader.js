...
exports.DatasetLoader = exports.fetchSemaphore = exports.ROLLUP_FIELD_DEFAULTS = exports.DEPRECATED_LAYOUT_ERROR = exports.DATASET_CANDIDATE_PATHS = void 0;
exports.normalizeRollup = normalizeRollup;
exports.normalizeRollups = normalizeRollups;
exports.createRollupCache = createRollupCache;
 ...
 */
exports.DATASET_CANDIDATE_PATHS = [
 ...
 */
exports.DEPRECATED_LAYOUT_ERROR = 'Deprecated dataset layout detected (aggregates/aggregates nesting). ' +
...
function normalizeRollup(rollup) {
    if (!rollup || typeof rollup !== 'object') {
        return { week: 'unknown', ...exports.ROLLUP_FIELD_DEFAULTS };
    }
    return {
        // Preserve all existing fields
        ...rollup,
        // Ensure required fields have defaults (don't override if already set)
        pr_count: rollup.pr_count ?? exports.ROLLUP_FIELD_DEFAULTS.pr_count,
        cycle_time_p50: rollup.cycle_time_p50 ?? exports.ROLLUP_FIELD_DEFAULTS.cycle_time_p50,
        cycle_time_p90: rollup.cycle_time_p90 ?? exports.ROLLUP_FIELD_DEFAULTS.cycle_time_p90,
        authors_count: rollup.authors_count ?? exports.ROLLUP_FIELD_DEFAULTS.authors_count,
        reviewers_count: rollup.reviewers_count ?? exports.ROLLUP_FIELD_DEFAULTS.reviewers_count,
...
class DatasetLoader {
    constructor(baseUrl) {
        this.effectiveBaseUrl = null; // Resolved after probing
        this.manifest = null;
    ...
    async resolveDatasetRoot() {
        ...
        for (const candidate of exports.DATASET_CANDIDATE_PATHS) {
    ...
    async getWeeklyRollupsWithProgress(startDate, endDate, context, onProgress = () => { }, cache = null) {
        ...
        const batches = [];
        for (let i = 0; i < weeksToFetch.length; i += exports.fetchSemaphore.maxConcurrent) {
            batches.push(weeksToFetch.slice(i, i + exports.fetchSemaphore.maxConcurrent));
        }
        let loaded = 0;
    ...
    async _fetchWeekWithRetry(weekStr, indexEntry, context, cache) {
        let retries = 0;
        while (retries <= exports.fetchSemaphore.maxRetries) {
            await exports.fetchSemaphore.acquire();
            try {
                const url = this.resolvePath(indexEntry.path);
                const response = await fetch(url);
                if (response.ok) {
                ...
                // 5xx - retry once
                if (response.status >= 500 && retries < exports.fetchSemaphore.maxRetries) {
                    retries++;
                    await this._delay(exports.fetchSemaphore.retryDelayMs);
                    continue;
                }
                ...
                if (retries < exports.fetchSemaphore.maxRetries) {
                    retries++;
                    await this._delay(exports.fetchSemaphore.retryDelayMs);
                    continue;
                }
                ...
                exports.fetchSemaphore.release();
            }
        }
