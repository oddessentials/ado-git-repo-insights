...
function getErrorByCode(code) {
  for (const error of Object.values(exports.ErrorCodes)) {
    if (error.code === code) {
      return error;
    }
  }
...
function createErrorMessage(errorKey, details = null) {
  const error = exports.ErrorCodes[errorKey] ?? exports.ErrorCodes.UNKNOWN;
  return {
    code: error.code,
...
if (typeof window !== "undefined") {
  window.ErrorCodes = exports.ErrorCodes;
