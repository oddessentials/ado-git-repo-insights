 ...
 */
export declare function getErrorByCode(code: string): ErrorCodeDefinition | null;
/**
 ...
 */
export declare function createErrorMessage(errorKey: string, details?: string | null): ErrorMessage;
