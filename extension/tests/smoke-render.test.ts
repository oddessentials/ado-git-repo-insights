...
describe('Smoke Render Tests (ADO Simulation)', () => {
    ...
    describe('Settings Page', () => {
        ...
        it('settings.html has required DOM elements', () => {
            ...
            expect(
                dom.window.document.getElementById('save-btn')
            ).not.toBeNull();
            expect(
                dom.window.document.getElementById('clear-btn')
            ).not.toBeNull();
            expect(
                dom.window.document.getElementById('pipeline-id')
            ).not.toBeNull();
            expect(
                dom.window.document.getElementById('project-id')
            ).not.toBeNull();
            expect(
