...
const { ArtifactClient } = require('../ui/artifact-client');
...
describe('ArtifactClient Authentication Pattern', () => {
    ...
    beforeEach(() => {
        ...
        mockVSS = {
            ...
            getAccessToken: jest.fn(() => Promise.resolve({ token: 'mock-token-12345' })),
            getService: jest.fn(() => {
    ...
    describe('initialize()', () => {
        ...
        it('should extract token from getAccessToken result correctly', async () => {
            ...
            expect(client.authToken).toBe(expectedToken);
        });
        ...
        it('should handle getAccessToken returning token in correct format', async () => {
            ...
            expect(client.authToken).toBe('format-test-token');
        });
    });
