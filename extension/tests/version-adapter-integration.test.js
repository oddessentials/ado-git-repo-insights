...
describe('Version Adapter Integration', () => {
                ...
                if (url.includes('manifest')) {
                    return {
                        ...
                        json: async () => ({
                            ...
                            coverage: { total_prs: 50, date_range: { min: '2026-01-01', max: '2026-01-07' } },
                            features: {},
                            aggregate_index: {
    ...
    describe('getWeeklyRollupsWithProgress (concurrent loading)', () => {
        it('normalizes rollups in concurrent path', async () => {
            ...
            const result = await loader.getWeeklyRollupsWithProgress(
                new Date('2024-01-01'),
                new Date('2024-01-07'),
                { week: '2024-W01', org: 'test', project: 'test', repo: 'test' }
            );
    ...
    describe('Graceful degradation', () => {
        it('handles malformed rollup gracefully', async () => {
                ...
                if (url.includes('manifest')) {
                    return {
                        ...
                        json: async () => ({
                            ...
                            dataset_schema_version: 1,
                            aggregates_schema_version: 1,
                            coverage: { total_prs: 1, date_range: { min: '2024-01-01', max: '2024-01-07' } },
                            features: {},
                            aggregate_index: {
            ...
            expect(rollup.invalid).toBe(true);
