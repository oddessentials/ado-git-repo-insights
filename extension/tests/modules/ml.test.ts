...
import type { PredictionsRenderData, InsightsRenderData, PredictionsData, InsightsData } from "../../ui/types";
            ...
            forecasts: [
                {
                    ...
                    unit: "count",
                    values: [
                        { period_start: "2024-W01", predicted: 10, lower_bound: 8, upper_bound: 12 },
                    ],
                },
            ],
        };
...
describe("renderAIInsights", () => {
    ...
    it("renders insights grouped by severity", () => {
        const insights: InsightsRenderData = {
            insights: [
                { severity: "critical", category: "Performance", title: "Slow", description: "Too slow" },
                { severity: "warning", category: "Process", title: "Warn", description: "Watch out" },
                { severity: "info", category: "FYI", title: "Info", description: "Just info" },
            ],
        };
...
describe("createMlRenderer", () => {
    ...
    it("handles prediction load errors", async () => {
        mockProvider = {
            loadPredictions: jest.fn().mockRejectedValue(new Error("Network failure")),
            loadInsights: jest.fn(),
        };
    ...
    it("loads and renders insights successfully", async () => {
        const insightsData: InsightsData = {
            ...
            data: {
                insights: [
                    { severity: "info", category: "Test", title: "Title", description: "Desc" },
                ],
            },
        };
