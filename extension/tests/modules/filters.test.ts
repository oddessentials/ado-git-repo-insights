...
describe("filters module", () => {
    ...
    describe("hasActiveFilters", () => {
        ...
        it("returns true when both have values", () => {
            expect(hasActiveFilters({ repos: ["repo-a"], teams: ["team-x"] })).toBe(true);
        });
    });
    ...
    describe("serializeFiltersToUrl", () => {
        it("sets repos and teams params", () => {
            const params = new URLSearchParams();
            const state: FilterState = { repos: ["repo-a", "repo-b"], teams: ["team-x"] };
    ...
    describe("createFilterChipHtml", () => {
        ...
        it("escapes HTML in label", () => {
            const html = createFilterChipHtml("repo", "test", "<script>alert(1)</script>");
