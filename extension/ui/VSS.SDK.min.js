    ...
    return (
      ...
      (t.prototype.invokeMethod = function (n, t) {
        ...
        if (((r = n[t.methodName]), typeof r != "function")) {
          this._error(
            t,
            new Error("RPC method not found: " + t.methodName),
            t.handshakeToken,
          );
          return;
        }
      ...
      (t.prototype.onMessage = function (n) {
        ...
        if (t.instanceId) {
          if (
            ((i = this.getRegisteredObject(t.instanceId, t.instanceContext)),
            !i)
          )
            return !1;
      ...
      (t.prototype.owns = function (n, t, i) {
        ...
        if (this._postToWindow === n) {
          if (this._targetOrigin)
            return t
              ? t.toLowerCase() === "null" ||
                  this._targetOrigin.toLowerCase().indexOf(t.toLowerCase()) ===
                    0
              : !1;
      ...
      (t.prototype._shouldSkipSerialization = function (n) {
        for (
          var r, i = 0, u = t.WINDOW_TYPES_TO_SKIP_SERIALIZATION.length;
          i < u;
          i++
        )
          if (
            ((r = t.WINDOW_TYPES_TO_SKIP_SERIALIZATION[i]),
            window[r] && n instanceof window[r])
          )
            return !0;
        if (window.jQuery)
          for (
            i = 0, u = t.JQUERY_TYPES_TO_SKIP_SERIALIZATION.length;
            i < u;
            i++
          )
            if (
      ...
      (t.prototype._customSerializeObject = function (n, i, r, u, f) {
        ...
        if (
          ...
          for (o = [], r.newObjects.push(o), e = 0, c = n.length; e < c; e++)
            a(n, o, e);
        else {
          o = {};
          r.newObjects.push(o);
          ...
          try {
            for (s in n) l[s] = !0;
            for (
              v = Object.getOwnPropertyNames(n), e = 0, c = v.length;
              e < c;
              e++
            )
              l[v[e]] = !0;
          ...
          for (s in l)
            ((s && s[0] !== "_") || (i && i.includeUnderscoreProperties)) &&
              a(n, o, s);
        }
      ...
      (n.prototype._handleMessageReceived = function (n) {
        ...
        if (t) {
          for (u = !1, i = 0, e = this._channels.length; i < e; i++)
            ((r = this._channels[i]),
              r.owns(n.source, n.origin, t) &&
                ((f = r), (u = r.onMessage(t, n.origin) || u)));
          !f ||
            u ||
            (window.console &&
              console.error(
  ...
  (function (n) {
    function yt() {
      ...
      t ||
        ...
        Object.defineProperty(window, "sessionStorage", { value: new nt() }));
    }
    function tt(f) {
      r = f || {};
      o = r.usePlatformScripts;
      v = r.usePlatformStyles;
      window.setTimeout(function () {
        var f = {
        ...
        i.invokeRemoteMethod("initialHandshake", "VSS.HostControl", [f]).then(
          function (n) {
            var f, r, e, h, c, s, a, i;
            if (
              ((t = n.pageContext),
              ...
              (d = n.initialConfig || {}),
              (g = n.contribution),
              (l = n.extensionContext),
              n.sandboxedStorage)
            ) {
              if (((f = !1), u))
                if (n.sandboxedStorage.localStorage) {
                  for (
                    r = n.sandboxedStorage.localStorage,
                      e = 0,
                      h = Object.keys(u);
                    e < h.length;
                    e++
                    ...
                    ((i = h[e]),
                      (c = u.getItem(i)),
                      c !== r[i] && ((r[i] = c), (f = !0)));
                  for (s = 0, a = Object.keys(r); s < a.length; s++)
                    ((i = a[s]), u.setItem(i, r[i]));
                } else u.length > 0 && (f = !0);
              vt = !0;
              f && it();
            }
            n.themeData && ct(n.themeData);
            o || v ? lt() : b();
          },
        );
      }, 0);
    ...
    function ut(n) {
      h ? window.setTimeout(n, 0) : (f || (f = []), f.push(n));
    }
    function kt() {
    ...
    function ni(n, t) {
      return st(n).then(function (n) {
        return (
          t || (t = {}),
          t.webContext || (t.webContext = et()),
          t.extensionContext || (t.extensionContext = ot()),
    ...
    function st(t) {
      ...
      return (
        n.ready(function () {
          i.invokeRemoteMethod("getServiceContribution", "vss.hostManagement", [
            t,
          ]).then(function (n) {
            var t = n;
    ...
    function ht(t, r, u) {
      ...
      return (
        n.ready(function () {
          i.invokeRemoteMethod(
            "getBackgroundContributionInstance",
            "vss.hostManagement",
            [t, r, u],
    ...
    function oi(n, t) {
      s || (s = document.getElementsByTagName("body").item(0));
      var r = typeof n == "number" ? n : s.scrollWidth,
        u = typeof t == "number" ? t : s.scrollHeight;
    ...
    function lt() {
      ...
      if (
        ...
        t.coreReferences.scripts &&
          (t.coreReferences.scripts.forEach(function (n) {
            if (n.isCoreModule) {
              ...
              r ? (g = !0) : f.push({ source: c(n.url, i) });
            }
          }),
          t.coreReferences.coreScriptsBundle &&
            !g &&
            (f = [{ source: c(t.coreReferences.coreScriptsBundle.url, i) }]),
          t.coreReferences.extensionCoreReferences &&
            f.push({
              source: c(t.coreReferences.extensionCoreReferences.url, i),
            })),
        (n = {
          baseUrl: l.baseUri,
        ...
        r.moduleLoaderConfig &&
          (r.moduleLoaderConfig.baseUrl &&
            (n.baseUrl = r.moduleLoaderConfig.baseUrl),
          hi(r.moduleLoaderConfig, n),
          at(r.moduleLoaderConfig, n)),
        t.moduleLoaderConfig &&
          (at(t.moduleLoaderConfig, n),
          (s = t.moduleLoaderConfig.contributionPaths),
          s))
      )
        for (e in s)
          if (
            ...
            !n.paths[e] &&
            ((h = s[e].value),
            (n.paths[e] = h.match("^https?://") ? h : i + h),
            (k = t.moduleLoaderConfig.paths),
            k)
          ) {
            nt = e + "/";
            tt = y(i, t.moduleLoaderConfig.baseUrl);
            for (d in k)
              si(d, nt) &&
                ((u = k[d]),
                u.match("^https?://") ||
    ...
    function si(n, t) {
      return n && n.length >= t.length
        ? n.substr(0, t.length).localeCompare(t) === 0
        : !1;
    }
    function y(n, t) {
      var i = n || "";
    ...
    function at(n, t) {
      if (n.shim) {
        t.shim || (t.shim = {});
        for (var i in n.shim)
          n.shim.hasOwnProperty(i) && (t.shim[i] = n.shim[i]);
      }
    }
    function ci(n) {
      ...
      n[t].source
        ? ((u = n[t].source),
          ...
          r.addEventListener("error", function () {
            ft("Failed to load script: " + u);
          }),
          w(r, "head"))
        : n[t].content &&
          ((r.textContent = n[t].content),
          w(r, "head"),
          p.call(this, n, t + 1, i));
    }
    function w(n, t) {
    ...
    })((wt = n.ServiceIds || (n.ServiceIds = {})));
    n.init = tt;
    n.require = bt;
    n.ready = ut;
    n.notifyLoadSucceeded = kt;
    n.notifyLoadFailed = ft;
    n.getWebContext = et;
    n.getConfiguration = dt;
    n.getExtensionContext = ot;
    n.getContribution = gt;
    n.getService = ni;
    n.getServiceContribution = st;
    n.getServiceContributions = ti;
    n.register = ii;
    n.unregister = ri;
    n.getRegisteredObject = ui;
    n.getAccessToken = fi;
    n.getAppToken = ei;
    n.resize = oi;
    n.applyTheme = ct;
