...
- **FR-005b**: Extension MUST list available projects by importing the appropriate REST client from the API package (`azure-devops-extension-api`), replacing the current `VSS.require(["TFS/Core/RestClient"])` dynamic module loading pattern.
