...
- **Cumulative test additions**: Phase 2 +30 Python +9 Extension; Phase 3 +12 Extension; Phase 4 +4 Extension; Phase 5 +4 Extension; Phase 6 +3 Extension; Phase 7 +3 Extension. **Cumulative target**: +30 Python + +35 Extension across the PR. Verified at task time via `scripts/check_ratchet_bump.py` (T033).
