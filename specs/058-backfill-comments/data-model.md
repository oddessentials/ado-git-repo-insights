...
Extract keeps its existing logic at `cli.py:610-628` — full-success set / truncation-preserve `pass` / truncation-clear NULL — without modification under this feature. Extract's observable behavior is locked by `tests/unit/test_extract_comments.py` (759 LOC, 19 tests, FR-034).
